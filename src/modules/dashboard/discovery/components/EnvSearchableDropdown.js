...
export const EnvSearchableDropdown = ({
    style,
    name,
    api,
    keyword,
    ...
    return (
        <>
            <div className={classes.label}>{props.label} {required && <span style={{ color: 'red', fontSize: 14 }}>*</span>}</div>
            <Autocomplete            
                size="small"
                style={style}
                open={open}
                ...
                value={options.find(v => v.id === value) || ''}
