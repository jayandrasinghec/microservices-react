...
export default function ContractorsEndDate(props) {
    ...
    return (
        <>
            <ReportGrid 
                ...
                title="Contractors with upcoming contract end date"
                description={"List of contractors having contract end date in next 30 days."}
                mappings={mappings}
                body={body}
