...
export default function AppSelectInput(props: IProps & TextFieldProps) {
  ...
  return (
    <div style={style} className={className}>
      ...
      <TextField
        ...
        {props.options.map((o, index) => <MenuItem key={o.key} disabled={o.isDisable} value={o.key}>{labels[index]}</MenuItem>)}
      </TextField>
    </div>
  )
}