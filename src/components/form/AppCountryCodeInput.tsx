...
export default function AppCountryCodeInput(props: any) {
  ...
  if (props.value && countries.length === 0) return <div />
  ...
  return (
    <div className={className}>
      ...
      <Autocomplete
        ...
        onInputChange={(e, val) => props.onChange(val.replace('+', ''))}
        autoHighlight
        inputValue={`+${value}`}
        getOptionLabel={(option: any) => {
          const code = countries.find(u => u.phone == option.phone)
